...
export function new_rgb() {
    return { r: 0, g: 0, b: 0 };
}
export function new_oklab() {
    return { L: 0, a: 0, b: 0 };
}
export function rgb_to_oklab(c, o) {
    if (!o) {
        o = new_oklab();
        rgb_to_oklab(c, o);
        return o;
...
export function oklab_to_rgb(ok, c) {
    if (!c) {
        c = new_rgb();
        oklab_to_rgb(ok, c);
        return c;
 ...
 */
export function oklab_to_css_string(ok, alpha) {
 ...
 */
export function rgb_to_css_string(c, alpha) {
    if (typeof alpha != 'number')
...
export function hex_to_rgb(hex, c) {
    if (!c) {
        c = new_rgb();
        hex_to_rgb(hex, c);
        return c;
